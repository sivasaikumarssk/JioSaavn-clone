...
{/* ------------------------------------------Right------------------------------------------ */}
            <div className="Sp_right">
                ...
                <Link to={"/login"}><RegisterButton className="loogbtn">Login</RegisterButton></Link>
                ...
                <form onSubmit={(event)=>{
                    ...
                    <RegisterButton background='#2a2d36' color='white' className="mob1">Mobile Number</RegisterButton>
                    <RegisterButton background='#3d5798' color="white" className="fb1">  FaceBook  </RegisterButton>                       
                    </div>
